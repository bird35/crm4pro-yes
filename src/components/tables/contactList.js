...
export default function CList() {
    ...
    const [state] = React.useState({
        columns: [
            { title: "Contact Id", field: "_id", hidden: true},
...
.catch(function(error) {
    ...
    editable={{
        ...
        onRowAdd: newData =>
            new Promise((resolve, reject) => {
                setTimeout(() => {
                    ...
                    axios.post('http://localhost:4000/contacts/signup', newData)
                    .then((res) => {
        ...
        new Promise(resolve => {
            ...
            axios.put(`http://localhost:4000/contacts/update-contact/${oldData._id}`, newData)
            .then((res) => {
                console.log(res.data)
            }).catch((error) => {
                console.log(error)
        ...
        new Promise(resolve => {
            ...
            axios.delete(`${'http://localhost:4000/contacts/delete-contact'}/${oldData._id}`)
