...
export default function DList() {
    ...
    const [state] = React.useState({
        columns: [
            { title: "Deal Id", field: "_id", hidden: true},
            ...
            { title: "Account", field: "account", draggable: true },
            { title: "Description", field: "description", draggable: true },
            { title: "NoCall", field: "noCall", draggable: true },
...
.catch(function(error) {
    ...
    editable={{
        ...
        onRowAdd: newData =>
            new Promise((resolve, reject) => {
                setTimeout(() => {
                    ...
                    axios.post('http://localhost:4000/deals/create-deal', newData)
                    .then((res) => {
        ...
        new Promise(resolve => {
            ...
            axios.put(`http://localhost:4000/deals/update-deal/${oldData._id}`, newData)
            .then((res) => {
                console.log(res.data)
            }).catch((error) => {
                console.log(error)
        ...
        new Promise(resolve => {
            ...
            axios.delete(`${'http://localhost:4000/deals/delete-deal'}/${oldData._id}`)
